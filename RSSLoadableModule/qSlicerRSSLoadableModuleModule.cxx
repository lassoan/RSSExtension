...
// RSSLoadableModule Logic includes
#include <vtkSlicerRSSLoadableModuleLogic.h>

// RSSLoadableModule includes
...
//-----------------------------------------------------------------------------
qSlicerRSSLoadableModuleModule
::qSlicerRSSLoadableModuleModule(QObject* _parent)
  : Superclass(_parent)
...
//-----------------------------------------------------------------------------
qSlicerAbstractModuleRepresentation * qSlicerRSSLoadableModuleModule
